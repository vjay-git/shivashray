...
export const hotelContent = {
  ...
  rooms: {
    double: {
      name: 'Double Room',
      description: 'Ideal for solo travelers, couples, or small families, our Double Room offers a cozy and well-appointed space for a peaceful stay.',
      highlights: ['Cozy space', 'Well-appointed', 'Perfect for solo travelers, couples, or small families'],
    },
    deluxe: {
      name: 'Deluxe Room',
      description: 'Our Deluxe Room offers all the features of the Double Room with extra space for added comfort, making it perfect for guests who prefer a more spacious setting.',
      highlights: ['Extra space', 'All Double Room features', 'More spacious setting'],
    },
    spacious: {
      name: 'Spacious Room',
      description: 'Experience ultimate comfort in our thoughtfully designed suite, perfect for families or groups.',
      highlights: ['Thoughtfully designed', 'Ultimate comfort', 'Perfect for families or groups'],
    },
  },
  ...
  marketing: {
    hero: {
      headline: 'Experience Spiritual Serenity in the Heart of Varanasi',
      subheadline: 'Whether you\'re here for a pilgrimage to the Kashi Vishwanath Temple, an immersive Ganga Aarti experience, or simply seeking a tranquil retreat, our personalized services ensure a memorable stay.',
      cta: 'Book Your Stay',
    },
    about: {
...
// Export individual content sections for easy use
export const {
  name: hotelName,
  tagline,
